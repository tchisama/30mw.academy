...
import { Circle, CheckCircle, Pipette, Settings2, PaintBucket, Medal, PencilRuler, Laptop, Laugh, Wifi, Clapperboard, Wand2 } from 'lucide-react';
      ...
      <div className='bg-slate-100 dark:bg-slate-950'>
        ...
        <div className='flex flex-col gap-4 flex-1'>
          ...
          <p className=' text-lg md:text-xl max-w-3xl'>
            استعد لتجربة استثنائية في عالم التصميم والمونتاج! تقدم دورتنا المسجلة لك فرصة الاستفادة من 8 ساعات من التدريب المكثف، مع شرح شامل وتطبيقات عملية. ستمكنك هذه الدورة من اكتساب المهارات اللازمة للعمل بفعالية على الإنترنت. انطلق نحو التحسين المهني واستعد لاستكشاف عوالم جديدة في مجال الإبداع والتكنولوجيا!
          </p>
        </div>
        <div className="relative"> 
          <Clapperboard strokeWidth={2} className="  absolute -top-8 drop-shadow-xl border -left-2 md:-left-10 z-10 text-[#2892df] p-4 md:p-6 rotate-12 md:w-24 w-16 h-16 md:h-24 dark:bg-slate-900/80 bg-white/70 backdrop-blur-md  rounded-3xl " />
          <Wand2 strokeWidth={2} className="  absolute -top-8 drop-shadow-xl border -right-2 z-10 text-[#2892df] p-6 -rotate-6 w-20 h-20 dark:bg-slate-900/80 bg-white/80 rounded-3xl backdrop-blur-md " />
          ...
          <Image className="w-[400px] drop-shadow-2xl h-[300px] md:h-[400px] object-cover rounded-3xl" width={500} alt="" height={500} src={montage}></Image>
        </div>
      </div>
          ...
          <div className="relative">
            ...
            <Image src={timeline} alt="" width={540} height={500} className="rounded-3xl shadow-2xl w-full md:w-[550px] md:h-[400px] object-cover"></Image>
          </div>
