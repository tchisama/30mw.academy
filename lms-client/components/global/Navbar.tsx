...
const Navbar = (props: Props) => {
  ...
  return (
    <div>
      ...
      <div
        dir="rtl"
        className="hidden md:flex w-full py-8 items-center justify-between"
      >
        <div className="flex-1">
          <Link href={"/"} className="flex drop-shadow-md items-center ">
            <Image
              className="h-14 w-14 dark:invert filter"
              height={50}
              width={50}
              src={logo}
              alt=""
        ...
        <div className="fixed p-4 flex flex-col gap-4 items-center top-0 left-0 h-screen w-screen bg-primary z-10">
          <div className="flex w-full  items-center justify-between">
            <Link href={"/"} onClick={() => setOpen(!open)}>
              <Image
                className="h-14 invert w-14 filter"
                height={50}
                width={50}
                src={logo}
                alt=""
            ...
            >
              <NavigationMenuItem onClick={() => setOpen(!open)}>
                <Link href="/" legacyBehavior passHref className="">
                  <NavigationMenuLink
                    className={
                      navigationMenuTriggerStyle() + " text-white text-xl"
                    }
                  >
                    الصفحة الرئيسية
                  </NavigationMenuLink>
